...
import { ChevronRight, CheckCircle2, Zap, LayoutGrid, Check } from "lucide-react";
import Image from "next/image";
import Link from "next/link";

const SPECS = [
  { label: "Conduit Standard", value: "Heavy Duty FRLS PVC" },
  { label: "Wire Specs", value: "IS-Certified Multi-strand" },
  { label: "File Formats", value: "PDF, DWG (AutoCAD), PNG" },
  { label: "Safety Code", value: "National Electrical Code (NEC)" },
];

const FEATURES = [
  {
    icon: <Zap className="w-5 h-5" />,
    title: "Switchboard Coordinates",
    desc: "Plotting switches at perfect heights and ergonomic distances near room entrance doors, bedsides, and kitchen counters.",
  },
  {
    icon: <LayoutGrid className="w-5 h-5" />,
    title: "Load Capacity Balancing",
    desc: "Distributing electrical loads evenly across phases and breakers, dedicating separate loops for 16A high-power appliances.",
  },
  {
    icon: <Zap className="w-5 h-5" />,
    title: "Lighting & Fan Placements",
    desc: "Coordinating ceiling fans, recessed downlights, track lighting, and fancy ambient hanging lights for optimal illumination grids.",
  },
  {
    icon: <LayoutGrid className="w-5 h-5" />,
    title: "Appliance Sockets Placement",
    desc: "Precisely allocating hidden power back-boxes for refrigerators, ovens, chimneys, water purifiers, and flat-screen TVs.",
  },
  {
    icon: <Zap className="w-5 h-5" />,
    title: "Conduit Pathway Planning",
    desc: "Mapping conduit runs within solid concrete slabs and false-ceiling suspension structures to eliminate drilling hazards.",
  },
  {
    icon: <LayoutGrid className="w-5 h-5" />,
    title: "Smart Automation Loops",
    desc: "Integrating low-voltage Cat6 Ethernet, surround sound speakers, and automation touch-panel conduits seamlessly.",
  },
];

const DELIVERABLES = [
  "Switchboard Location & Installation Height Map",
  "Lighting & Fan Fixture Circuit Loop Drawing",
  "Power Socket & Utility Back-Box Outlet Layout",
  "Circuit Breaker (MCB) & Distribution Board (DB) Chart",
  "False Ceiling Slab Conduit & Cable Route Drawing",
  "Low-Voltage Ethernet, TV, and Speaker Routing Diagram",
  "Original AutoCAD Source File (.DWG Format)",
  "High-Resolution Printable PDF Blueprints",
];

export default function ElectricalPlanPage() {
  return (
    <div className="bg-[#051124] min-h-screen text-white">
      ...
      <section className="relative pt-28 pb-0 overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 z-0">
          <Image
            src="/generated/2d_electrical_plan.png"
            alt="2D Electrical Plan Overview"
            fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-5xl py-20">
          ...
          <div className="flex items-center gap-2 text-accent/80 font-bold uppercase tracking-widest text-[10px] mb-6">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-accent">2D Electrical Plan</span>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight text-white">
              Looping <span className="text-gold italic">Blueprints</span>
            </h2>
          </div>
          ...
          <div className="max-w-4xl mx-auto rounded-[32px] overflow-hidden border border-white/10 bg-[#0a1f3d] p-6 shadow-2xl shadow-black/50">
            <div className="relative aspect-[4/3] w-full bg-white rounded-[20px] overflow-hidden p-4">
              <Image
                src="/generated/2d_electrical_plan.png"
                alt="Detailed 2D Electrical Plan Drawing"
                fill
                className="object-contain"
              />
            </div>
            <div className="mt-6 flex flex-wrap gap-3 justify-center">
              <span className="bg-[#1a2d4d]/90 text-[#5b9bd5] text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-[#5b9bd5]/30">Electrical CAD File</span>
              <span className="bg-[#1a2d4d]/90 text-accent text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-accent/30">DB Load Balance Mapped</span>
              <span className="bg-[#1a2d4d]/90 text-emerald-400 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-emerald-400/30">Zero post-plaster cutting</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-white/50 mt-4 text-sm font-semibold max-w-lg mx-auto">
              Every professional Electrical Plan drafted by the Galaxy Interior design studio includes these core engineering standards.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative rounded-[32px] overflow-hidden aspect-square border border-white/10">
              <Image
                src="/generated/2d_electrical_plan.png"
                alt="Electrical conduits mapping visual"
                fill
