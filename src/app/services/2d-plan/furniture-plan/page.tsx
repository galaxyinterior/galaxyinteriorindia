...
import { ChevronRight, CheckCircle2, Sofa, LayoutGrid, Check } from "lucide-react";
import Image from "next/image";
import Link from "next/link";

const SPECS = [
  { label: "Circulation Clearance", value: "36 inches minimum" },
  { label: "Standard Scale", value: "1:50 Metric Scale" },
  { label: "File Formats", value: "PDF, DWG (AutoCAD), PNG" },
  { label: "Design Revisions", value: "Unlimited drafts included" },
];

const FEATURES = [
  {
    icon: <Sofa className="w-5 h-5" />,
    title: "Space Circulation Maps",
    desc: "Drafting of explicit walking lanes and corridors to ensure zero structural dead ends and optimal ease of movement.",
  },
  {
    icon: <LayoutGrid className="w-5 h-5" />,
    title: "Exact-Scale Furniture",
    desc: "Placing of industry-standard scale dimensions for L-shaped sofas, king-size beds, 6-seater dining sets, and wardrobes.",
  },
  {
    icon: <Sofa className="w-5 h-5" />,
    title: "Door & Drawer Clearance",
    desc: "Pre-calculating opening tolerances for glass cabinetry, heavy wardrobes, main doors, and storage drawers.",
  },
  {
    icon: <LayoutGrid className="w-5 h-5" />,
    title: "Strategic Sightlines",
    desc: "Arranging seating orientations to maximize visual focus on television screens, natural window views, and entry gateways.",
  },
  {
    icon: <Sofa className="w-5 h-5" />,
    title: "Zoning & Conversational Hubs",
    desc: "Creating close and comfortable seating groups in double-height living rooms and spacious lounges.",
  },
  {
    icon: <LayoutGrid className="w-5 h-5" />,
    title: "Structural Coordination",
    desc: "Aligning heavy credenzas and console tables with RCC structural columns and wall offsets for built-in visual continuity.",
  },
];

const DELIVERABLES = [
  "Comprehensive Scaled Furniture Placement Layout Map",
  "Walkway & Traffic Circulation Clearance Map",
  "Hinge & Cabinet Swing Swing-Tolerance Index",
  "Sightline and Viewing Angle Calculation Sheet",
  "Wardrobe & Storage Depth Blueprint Profiles",
  "Custom Shelving and Nook Clearance Allocations",
  "AutoCAD Source File (.DWG Format)",
  "Printable High-Resolution A3 PDF Document",
];
      ...
      <section className="relative pt-28 pb-0 overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="2D Furniture Plan Overview"
            fill
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-5xl py-20">
          ...
          <div className="flex items-center gap-2 text-accent/80 font-bold uppercase tracking-widest text-[10px] mb-6">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-accent">2D Furniture Plan</span>
          </div>
          ...
          <h1 className="font-display text-5xl md:text-8xl font-black tracking-tight mb-6 uppercase leading-none">
            2D <span className="text-gold italic">Furniture</span> Plan
          </h1>
          <p className="max-w-2xl text-base md:text-lg text-white/60 font-semibold leading-relaxed mb-10">
            Optimize your floor plan for actual usability. We map out standard furniture outlines to exact proportions on your layout, checking corridors, clearances, and viewpoints to establish fluid room flows.
          </p>
          <div className="flex flex-wrap gap-4">
            <Button asChild className="rounded-full px-10 h-14 font-black uppercase tracking-[0.15em] bg-accent hover:bg-accent/90 text-primary shadow-lg shadow-accent/20 hover:scale-105 active:scale-95 transition-all">
              <Link href="/contact?service=2D%20Furniture%20Plan">Get a Free Quote</Link>
            </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight text-white">
              Space <span className="text-gold italic">Circulation</span>
            </h2>
          </div>
          ...
          <div className="max-w-4xl mx-auto rounded-[32px] overflow-hidden border border-white/10 bg-[#0a1f3d] p-6 shadow-2xl shadow-black/50">
            <div className="relative aspect-[4/3] w-full bg-white rounded-[20px] overflow-hidden p-4">
              <Image
                src="/generated/2d_furniture_plan.png"
                alt="Detailed 2D Furniture Plan Drawing"
                fill
                className="object-contain"
              />
            </div>
            <div className="mt-6 flex flex-wrap gap-3 justify-center">
              <span className="bg-[#1a2d4d]/90 text-[#5b9bd5] text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-[#5b9bd5]/30">AutoCAD Template</span>
              <span className="bg-[#1a2d4d]/90 text-accent text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-accent/30">Ergonomic Walking Lanes</span>
              <span className="bg-[#1a2d4d]/90 text-emerald-400 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-emerald-400/30">Scale Proportion Check Done</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-white/50 mt-4 text-sm font-semibold max-w-lg mx-auto">
              Every professional Furniture Plan drafted by the Galaxy Interior design studio includes these core layout standards.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button asChild className="mt-10 rounded-full px-10 h-14 font-black uppercase tracking-[0.15em] bg-accent hover:bg-accent/90 text-primary shadow-lg shadow-accent/20 hover:scale-105 active:scale-95 transition-all">
                <Link href="/contact?service=2D%20Furniture%20Plan">Enquire For Furniture Plan</Link>
              </Button>
            </div>
            <div className="relative rounded-[32px] overflow-hidden aspect-square border border-white/10">
              <Image
                src="/generated/2d_furniture_plan.png"
                alt="Furniture plan layout draft"
                fill
