...
const features = [
  {
    ...
    description: "No dealing with multiple contractors. We manage the architects, engineers, masons, and carpenters.",
    icon: Key,
  },
  {
    title: "Architectural Design",
    description: "Full blueprints, 2D plans, and 3D elevations designed to maximize space and aesthetics.",
    icon: Layout,
  },
  {
    title: "Civil Construction",
    description: "Solid foundation and framing executed by experienced civil engineers and supervisors.",
    icon: HardHat,
  },
  {
    title: "Complete Interiors",
    description: "From flooring to false ceilings, modular kitchens, and custom furniture—fully finished.",
    icon: PaintBucket,
  },
  {
    title: "Hassle-Free Handover",
    description: "We handle the entire build process until the keys are handed over, ready for you to move in.",
    icon: Map,
  }
];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-primary tracking-tighter leading-tight uppercase">
              Complete <span className="text-accent">Turnkey</span> Projects
            </h1>
            <p className="text-gray-600 text-lg max-w-2xl leading-relaxed">
              The ultimate stress-free building experience. From empty plot to fully furnished home, Galaxy Interior manages every single detail. Just turn the key and move in.
            </p>
          ...
          <div className="flex-1 relative w-full aspect-video lg:aspect-square rounded-[32px] overflow-hidden shadow-2xl">
            <Image 
              src="/generated/hero_interior_1.png" 
              alt="Completed Turnkey Home" 
              fill 
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24 py-24">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-3xl md:text-4xl font-black text-primary uppercase tracking-tight">The Turnkey Advantage</h2>
          <div className="w-16 h-1 bg-accent mx-auto"></div>
          <p className="text-gray-500 max-w-2xl mx-auto">
            Why stress over coordinating contractors when one team can handle it all with complete accountability?
          </p>
        </div>
      ...
      <div className="bg-gray-50 py-24 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24 flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">Absolutely everything. We take responsibility for the entire lifecycle of the build.</p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {['Site Survey & Planning', 'Architectural & 3D Design', 'Civil Construction', 'Plumbing & Electrical', 'Flooring & Tiling', 'Painting & Finishing', 'Custom Interior Furnishing', 'Final Cleanup & Handover'].map((item, idx) => (
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-12 my-24">
        <div className="bg-primary rounded-[32px] p-12 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 space-y-6">
            <h3 className="text-3xl md:text-4xl font-black text-white uppercase tracking-tight">Ready for a stress-free build?</h3>
            <p className="text-white/70 max-w-xl mx-auto">
              Discuss your plot details with us and let our team manage the rest.
            </p>
            <div className="mt-8">
              <Link href="/contact">
